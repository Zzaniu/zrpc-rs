...
pub struct AddUserRequest {
    ...
    pub hobby: ::prost::alloc::vec::Vec<::prost::alloc::string::String>,
    #[prost(map = "string, float", tag = "4")]
    pub score: ::std::collections::HashMap<::prost::alloc::string::String, f32>,
}
/// user add response
...
pub mod user_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static("/user.User/Add");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new("user.User", "Add"));
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/user.User/Get");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new("user.User", "Get"));
            self.inner.unary(req, path, codec).await
        }
    }
}
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/user.User/Add" => {
                    ...
                    struct AddSvc<T: User>(pub Arc<T>);
                    ...
                    for AddSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as User>::add(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
